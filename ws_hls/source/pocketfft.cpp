...
static void my_sincosm1pi (double a, double *__restrict__ res)
  {
  double s = a * a;
...
NOINLINE static void calc_first_octant(size_t den, double * __restrict__ res)
  {
  size_t n = (den+4)>>3;
  if (n==0) return;
  res[0]=1.; res[1]=0.;
...
NOINLINE static void calc_first_quadrant(size_t n, double * __restrict__ res)
  {
  double * __restrict__ p = res+n;
...
NOINLINE static void calc_first_half(size_t n, double * __restrict__ res)
  {
  int ndone=(n+1)>>1;
  double * p = res+n-1;
...
NOINLINE static void fill_first_quadrant(size_t n, double * __restrict__ res)
  {
...
NOINLINE static void fill_first_half(size_t n, double * __restrict__ res)
  {
  size_t half = n>>1;
  if ((n&3)==0)
...
NOINLINE static void fill_second_half(size_t n, double * __restrict__ res)
  {
  if ((n&1)==0)
...
NOINLINE static void sincos_2pibyn_half(size_t n, double * __restrict__ res)
  {
  if ((n&3)==0)
    {
...
NOINLINE static void sincos_2pibyn(size_t n, double * __restrict__ res)
  {
...
NOINLINE static void pass2b (size_t ido, size_t l1, const cmplx * __restrict__ cc,
  cmplx * __restrict__ ch, const cmplx * __restrict__ wa)
  {
  const size_t cdim=2;
...
NOINLINE static void pass2f (size_t ido, size_t l1, const cmplx * __restrict__ cc,
  cmplx * __restrict__ ch, const cmplx * __restrict__ wa)
  {
  const size_t cdim=2;
...
NOINLINE static void pass3b (size_t ido, size_t l1, const cmplx * __restrict__ cc,
  cmplx * __restrict__ ch, const cmplx * __restrict__ wa)
  {
  const size_t cdim=3;
...
NOINLINE static void pass3f (size_t ido, size_t l1, const cmplx * __restrict__ cc,
  cmplx * __restrict__ ch, const cmplx * __restrict__ wa)
  {
  const size_t cdim=3;
  const double tw1r=-0.5, tw1i= -0.86602540378443864676;
...
NOINLINE static void pass4b (size_t ido, size_t l1, const cmplx * __restrict__ cc,
  cmplx * __restrict__ ch, const cmplx * __restrict__ wa)
  {
  const size_t cdim=4;
...
NOINLINE static void pass4f (size_t ido, size_t l1, const cmplx * __restrict__ cc,
  cmplx * __restrict__ ch, const cmplx * __restrict__ wa)
  {
  const size_t cdim=4;
...
NOINLINE static void pass5b (size_t ido, size_t l1, const cmplx * __restrict__ cc,
  cmplx * __restrict__ ch, const cmplx * __restrict__ wa)
  {
  const size_t cdim=5;
...
NOINLINE static void pass5f (size_t ido, size_t l1, const cmplx * __restrict__ cc,
  cmplx * __restrict__ ch, const cmplx * __restrict__ wa)
  {
  const size_t cdim=5;
  const double tw1r= 0.3090169943749474241,
...
NOINLINE static void pass7(size_t ido, size_t l1, const cmplx * __restrict__ cc,
  cmplx * __restrict__ ch, const cmplx * __restrict__ wa, const int sign)
  {
  const size_t cdim=7;
...
NOINLINE static void pass11 (size_t ido, size_t l1, const cmplx * __restrict__ cc,
  cmplx * __restrict__ ch, const cmplx * __restrict__ wa, const int sign)
  {
...
NOINLINE static int passg (size_t ido, size_t ip, size_t l1,
  cmplx * __restrict__ cc, cmplx * __restrict__ ch, const cmplx * __restrict__ wa,
  const cmplx * __restrict__ csarr, const int sign)
  {
  const size_t cdim=ip;
  size_t ipph = (ip+1)/2;
  size_t idl1 = ido*l1;

  cmplx * __restrict__ wal=RALLOC(cmplx,ip);
  if (!wal) return -1;
  wal[0]=(cmplx){1.,0.};
...
NOINLINE static void radf2 (size_t ido, size_t l1, const double * __restrict__ cc,
  double * __restrict__ ch, const double * __restrict__ wa)
  {
  const size_t cdim=2;
...
NOINLINE static void radf3(size_t ido, size_t l1, const double * __restrict__ cc,
  double * __restrict__ ch, const double * __restrict__ wa)
  {
  const size_t cdim=3;
...
NOINLINE static void radf4(size_t ido, size_t l1, const double * __restrict__ cc,
  double * __restrict__ ch, const double * __restrict__ wa)
  {
  const size_t cdim=4;
...
NOINLINE static void radf5(size_t ido, size_t l1, const double * __restrict__ cc,
  double * __restrict__ ch, const double * __restrict__ wa)
  {
  const size_t cdim=5;
...
NOINLINE static void radfg(size_t ido, size_t ip, size_t l1,
  double * __restrict__ cc, double * __restrict__ ch, const double * __restrict__ wa,
  const double * __restrict__ csarr)
  {
  const size_t cdim=ip;
  size_t ipph=(ip+1)/2;
  size_t idl1 = ido*l1;
...
NOINLINE static void radb2(size_t ido, size_t l1, const double * __restrict__ cc,
  double * __restrict__ ch, const double * __restrict__ wa)
  {
  const size_t cdim=2;
...
NOINLINE static void radb3(size_t ido, size_t l1, const double * __restrict__ cc,
  double * __restrict__ ch, const double * __restrict__ wa)
  {
  const size_t cdim=3;
  static const double taur=-0.5, taui=0.86602540378443864676;
...
NOINLINE static void radb4(size_t ido, size_t l1, const double * __restrict__ cc,
  double * __restrict__ ch, const double * __restrict__ wa)
  {
  const size_t cdim=4;
...
NOINLINE static void radb5(size_t ido, size_t l1, const double * __restrict__ cc,
  double * __restrict__ ch, const double * __restrict__ wa)
  {
  const size_t cdim=5;
  static const double tr11= 0.3090169943749474241, ti11=0.95105651629515357212,
